...
export const AUTHOR_BY_ID_QUERY = defineQuery(`*[_type == "author" && _id == $_id][0]{
  _id,
  id,
  name,
  username,
...
export const STARTUPS_BY_AUTHOR_QUERY = defineQuery(`*[_type == "startup" && author->_id==$_id] | order(_createdAt desc) {
  _id,
  title, 
  slug, 
  _createdAt, 
